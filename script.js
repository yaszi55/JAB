...
roundLabel.style.top = "calc(10 * 41px + 6 * 41px + 5mm)";
...
scoreLabel.style.top = "calc(10 * 41px + 6 * 41px + 5mm)";
scoreLabel.style.left = "calc(6 * 41px - 4mm)";
...
for (let row = 0; row < 12; row++) {
  for (let col = 0; col < 17; col++) { // 🔄 korábbi 10 helyett 17 oszlop
...
newGameButton.style.top = "calc(12 * 41px + 6 * 41px + 4 mm)";
newGameButton.style.left = "calc(11 * 41px)";
